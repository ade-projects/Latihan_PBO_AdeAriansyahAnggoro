...
$daftarTiket = TiketVelvet::ambilSemuaData($pdo);
...
<head>
    ...
    <title>Data Tiket Studio Velvet - Admin Panel</title>
    ...
    <style>
        ...
        .card-header-custom {
            ...
            padding: 1.5rem;
            border-top: 4px solid var(--accent-velvet);
        }
        .btn-back {
    ...
    <div class="premium-card">
        <div class="card-header-custom d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center">
                <div class="p-2 rounded me-3" style="background-color: #fef3c7; color: var(--accent-velvet);">
                    <i class="bi bi-stars fs-4"></i>
                </div>
                <div>
                    <h4 class="mb-0 fw-bold">Studio Velvet <span class="badge bg-warning text-dark align-middle ms-2" style="font-size: 0.7rem; margin-top: -3px;">VIP CLASS</span></h4>
                    <p class="text-muted mb-0 small">Daftar riwayat penjualan tiket premium dengan surcharge 50%.</p>
                </div>
            </div>
        </div>
                        ...
                        <?php if ($totalData > 0): ?>
                            <?php foreach ($dataHalamanIni as $tiket): ?>
                                <tr>
                                    ...
                                    <td class="fw-bold" style="color: var(--accent-velvet);">
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="6" class="text-center py-5 text-muted">
                                    ...
                                    Belum ada data tiket untuk studio Velvet.
                                </td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
