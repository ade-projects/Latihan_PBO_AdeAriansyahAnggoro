...
$daftarTiket = TiketRegular::ambilSemuaData($pdo);
...
<head>
    ...
    <title>Data Tiket Studio Regular - Admin Panel</title>
    ...
    <style>
        ...
        .card-header-custom {
            ...
            padding: 1.5rem;
            border-top: 4px solid var(--accent-regular);
        }
        .btn-back {
        ...
        /* Kustomisasi Pagination Bootstrap */
...
<div class="container py-5 animate-fade">
    ...
    <div class="premium-card">
        <div class="card-header-custom d-flex align-items-center">
            <div class="p-2 rounded me-3" style="background-color: #e0f8fd; color: var(--accent-regular);">
                <i class="bi bi-collection-play-fill fs-4"></i>
            </div>
            <div>
                <h4 class="mb-0 fw-bold">Studio Regular</h4>
                <p class="text-muted mb-0 small">Daftar riwayat penjualan tiket kelas standar.</p>
            </div>
        </div>
                        ...
                        <?php if ($totalData > 0): ?>
                            <?php foreach ($dataHalamanIni as $tiket): ?>
                                <tr>
                                    ...
                                    <td class="fw-bold" style="color: var(--accent-regular);">
                                        Rp <?= number_format($tiket->hitungTotalHarga(), 0, ',', '.'); ?>
                                    </td>
                                    <td>
                                        <ul class="list-unstyled mb-0 text-muted">
                                            <?php foreach ($tiket->tampilkanInfoFasilitas() as $kunci => $nilai): ?>
                                                <li><span class="fw-medium text-dark"><?= $kunci; ?>:</span> <?= $nilai; ?></li>
                                            <?php endforeach; ?>
                                        </ul>
                                    </td>
                                </tr>
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="6" class="text-center py-5 text-muted">
                                    ...
                                    Belum ada data tiket untuk studio Regular.
                                </td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
